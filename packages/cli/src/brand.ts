...
// `@saas/sdk` client class name (`OrunCloud`) is intentionally NOT part of
...
export const CLI_BIN = "orun-cloud";

/** Product/brand name used in human-facing CLI copy. */
export const PRODUCT_NAME = "Orun Cloud";

/** Default API base URL when `--api-url` is not supplied. */
export const DEFAULT_API_URL = "https://api.orun.dev";
