// The Bridge (saas-copilot-surface CX0/CX1, design §1): the PURE translators
// from the platform's native wires — chat-v1 (the Workspace Agent thread) and
// attach-v1 (the delegated-session stream) — into the AG-UI dialect pinned in
// ./agui. No I/O, no bindings: chat-worker's doors and agents-worker's relay
...
// ── Session dialect (attach-v1 → AG-UI) ─────────────────────────────────────
