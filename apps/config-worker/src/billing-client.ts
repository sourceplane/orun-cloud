 ...
 */
export const INTERNAL_CALLER = "config-worker";
 ...
 * binding (IH7: the `limit.brokered_secrets` gate on brokered secret
 * creation). Fails closed: any network exception, non-OK HTTP status, or
