...
export function CatalogHeader({
  ...
  return (
    <div className="flex items-center gap-3 sm:gap-4">
      <h1 className="m-0 min-w-0 truncate text-[17px] font-semibold tracking-[-0.01em] text-[#fafafa] sm:text-[19px]">
        All services
      </h1>
      <div className="ml-auto flex shrink-0 gap-2 sm:gap-2.5">
        ...
        <button
          ...
          onClick={onImport}
          aria-label="Import"
          className="flex h-9 items-center gap-1.5 rounded-lg border border-[#232327] bg-transparent px-2.5 text-[13px] font-medium text-[#d4d4d8] transition-colors hover:border-[#3a3a40] sm:h-8 sm:px-[13px]"
        >
        ...
        <button
          type="button"
          onClick={onRegister}
          className="flex h-9 items-center gap-1.5 rounded-lg border border-[#f59e0b] bg-[#f59e0b] px-3 text-[13px] font-semibold text-[#1a1206] transition-colors hover:brightness-110 sm:h-8 sm:px-3.5"
        >
