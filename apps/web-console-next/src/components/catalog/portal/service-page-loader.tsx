...
export function ServicePageLoader({
  ...
  if (page) {
    return (
      <div className="h-[calc(100dvh-6rem)] overflow-hidden md:h-[calc(100dvh-3rem)]">
  ...
  if (loading && !entities) {
    return (
      <div className="flex h-[calc(100dvh-6rem)] flex-col gap-4 overflow-hidden p-1 md:h-[calc(100dvh-3rem)]">
