...
/**
 * Pending & historical invitations for a workspace (saas-settings-ia SI3 — the
 * "Pending" tab of People & Access). An invitation is a member who hasn't
 * accepted yet, so it lives on the same surface as the roster: invite from here,
 * and an accepted invite graduates into a Members row.
 */
export function InvitationsPanel({ orgId }: { orgId: string }) {
