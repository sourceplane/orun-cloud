...
| MCP9 | **Unification phase (D7)** — tool-manifest export: `packages/mcp` emits `tool-manifest.json` (names, schemas, annotations) as the enforced cross-implementation contract; freshness-tested; vendored by `orun` (UM1) | 🗓️ Planned |
