...
- AWS IAM roles and shared Terraform state buckets are owned by `aws-admin`.
  `orun-cloud` consumes the repo-scoped roles created there.
- Terraform state for `orun-cloud` uses the shared S3 buckets
...
- BF5 (saas-bootstrap-factory): infra components publish their consumable
  ...
  write scope (`sourceplane/orun-cloud/*`) already cover it.
...
- Verified plan role ARNs from Task 0004:
  - `arn:aws:iam::306024784101:role/dev-github-sourceplane-orun-cloud-plan`
  - `arn:aws:iam::306024784101:role/stage-github-sourceplane-orun-cloud-plan`
  - `arn:aws:iam::306024784101:role/prod-github-sourceplane-orun-cloud-plan`
- Verified deploy role ARNs from Task 0004:
  - `arn:aws:iam::306024784101:role/dev-github-sourceplane-orun-cloud-production-deploy`
  - `arn:aws:iam::306024784101:role/stage-github-sourceplane-orun-cloud-production-deploy`
  - `arn:aws:iam::306024784101:role/prod-github-sourceplane-orun-cloud-production-deploy`
- `aws-admin` PR #26 and main CI run `26204953054` verified Secrets Manager
  lifecycle access for `sourceplane/orun-cloud/*`.
